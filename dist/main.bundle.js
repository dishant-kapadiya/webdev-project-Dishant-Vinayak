...
var AdminComponent = (function () {
    function AdminComponent(router, userService, reviewService, titleService) {
        this.router = router;
...
var HomeComponent = (function () {
    ...
    HomeComponent.prototype.ngOnInit = function () {
        ...
        this.userService.fetchCurrentUser()
            ...
            if (data) {
                _this.loggedIn = true;
                _this.email = _this.sharedService.user['firstName'] || _this.sharedService.user['email'];
...
var ModeratorComponent = (function () {
    function ModeratorComponent(router, userService, reviewService, titleService) {
        this.router = router;
        this.userService = userService;
        this.reviewService = reviewService;
        this.titleService = titleService;
    ...
    ModeratorComponent.prototype.logout = function () {
        var _this = this;
        this.userService.logout()
            .subscribe(function (updatedUser) {
            location.reload(true);
